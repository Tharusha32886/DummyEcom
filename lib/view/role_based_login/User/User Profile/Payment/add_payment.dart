...
class _AddPaymentMethodState extends State<AddPaymentMethod> {
              ...
              children: [
                FutureBuilder(
                  ...
                  builder: (context, snapshot) {
                    if (snapshot.hasError) {
                      ...
                      return const Text("No payment systems availble");
                    }
                ...
                TextFormField(
                  ...
                  decoration: const InputDecoration(
                    ...
                    hintText: "eg.1230 4561 7890 8765",
                    border: OutlineInputBorder(),
                  ),
                  ...
                  validator: (value) {
                    if (value == null ||
                      ...
                      return "Provide a valid 16-digit card number";
                    }
                    return null;
                  },
                ),
  ...
  void addPaymentMethod() async {
    if (!_formKey.currentState!.validate()) {
      return; // dont proceed if the form is invlid
    }
    ...
    if (userId != null && selectedPaymentSystemData != null) {
      ...
      showSnackBar(context, "Failed to add payment method. Please try agian.");
    }
  }
}
